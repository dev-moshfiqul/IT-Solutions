document.addEventListener('DOMContentLoaded', () => {
 ...
 const rtlButton = document.getElementById('rtl-button');
    ...
    const savedDirection = localStorage.getItem('siteDirection');
    if (savedDirection === 'rtl') {
      html.setAttribute('dir', 'rtl');
      styleLink.setAttribute('href', 'assets/stylesheets/styles-rtl.css');

      if (rtlButton) {
        const rtlLabel = rtlButton.querySelector('.rtl-label');
        rtlLabel.textContent = 'LTR';
      }
    }

    // ✅ Only add button click logic if button exists
    if (!rtlButton || !styleLink) return;
    ...
    rtlButton.addEventListener('click', function () {
      ...
      if (isRTL) {
        ...
        styleLink.setAttribute('href', 'assets/stylesheets/styles.css');
        localStorage.setItem('siteDirection', 'ltr'); // 💾 Save
      } else {
        html.setAttribute('dir', 'rtl');
        rtlLabel.textContent = 'LTR';
        styleLink.setAttribute('href', 'assets/stylesheets/styles-rtl.css');
        localStorage.setItem('siteDirection', 'rtl'); // 💾 Save
      }
    });
